...
final class Store: ObservableObject {
    ...
    private let fileName = "cyclenote_entries.json"
    ...
    static func seedData() -> [Entry] {
        let now = Date()
        return [
            Entry(title: "Sample Entry One", detail: "First example entry.", date: now),
            Entry(title: "Sample Entry Two", detail: "Second example entry.", date: now.addingTimeInterval(-86400)),
            Entry(title: "Sample Entry Three", detail: "Third example entry.", date: now.addingTimeInterval(-172800)),
        ]
    }
}
